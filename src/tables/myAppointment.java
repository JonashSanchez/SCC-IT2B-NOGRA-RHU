...
public class myAppointment extends javax.swing.JFrame {
     ...
     */
    private String uid;
    public myAppointment(String uid) {
        initComponents();
       this.uid = uid;
    displayAppointments(uid);
    }
   ...
   public void displayAppointments(String uid) {
    try {
        ...
        String query = "SELECT a_id AS 'Appointment ID', u_id AS 'User ID', a_date AS 'Appointment Date', a_time AS 'Appointment Time', a_reason AS 'Reason' FROM tbl_appointments WHERE u_id = '" + uid + "'";
        ResultSet rs = dbc.getData(query);
        myAppo.setModel(DbUtils.resultSetToTableModel(rs));
        rs.close();
    ...
    private void initComponents() {
        ...
        myAppo.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3));
        myAppo.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(myAppo);
        ...
        jPanel1.add(med, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 210, -1));
    ...
    private void medMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_medMouseClicked
       int selectedRow = myAppo.getSelectedRow();
    if (selectedRow >= 0) {
        // Assuming the first column is a_id
    ...
    private javax.swing.JTable myAppo;
